...
export function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-6 pt-32 pb-24 lg:px-8"
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-5xl mx-auto w-full">
        ...
        <div className="mb-6 relative w-full">
          <motion.div
            ...
            className="absolute -top-10 left-0 md:-top-12 md:-left-8 -rotate-6 bg-neo-yellow neo-border px-3 py-1 shadow-[4px_4px_0_0_#000] z-20"
          >
            <span className="font-black text-lg md:text-xl">Hello! 👋</span>
          </motion.div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-black tracking-tighter uppercase leading-tight md:leading-none">
        ...
        <motion.div
          ...
          className="mb-8 mt-6 inline-block bg-black px-6 py-3"
        >
          <div className="text-lg sm:text-xl md:text-2xl font-bold text-white uppercase tracking-wider h-8">
        ...
        <motion.button
          ...
          className="mt-24 flex flex-col items-center gap-3 group"
